...
```javascript
{    "Version": "2008-10-17",    "Id": "Policy1397993518062",    "Statement": [        {            "Sid": "Stmt1397993241249",            "Effect": "Allow",            "Principal": {                "AWS": "*"            },            "Action": "s3:GetObject",            "Resource": "arn:aws:s3:::static.domain.com/*"        }    ]}
```
...
```markup
일반적인 S3 URl 형태s3-{리전 이름}.amazonaws.com/{버킷 이름}/{파일 이름}정적 웹 호스팅 URL 형태{버킷 이름}.s3-website-{리전 이름}.amazonaws.com/{파일 이름}
```
